                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            @foreach ($patients as $patient)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-left">
                                        <div class="flex items-center">
                                            <a href="{{ route('medical-histories.show', $patient) }}" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                    ...
                                    <td class="py-3 px-6 text-left">
                                        <div class="flex items-center">
                                            <a href="{{ route('vital-signs.show', $patient) }}" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <td class="py-3 px-6 text-left">
                                        <div class="flex items-center">
                                            <a href="{{ route('diagnostics.show', $patient) }}" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                </svg>
                                            </a>
